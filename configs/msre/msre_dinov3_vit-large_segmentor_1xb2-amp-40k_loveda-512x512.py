_base_ = [
    '../_base_/models/dinov3_vit-large_segmenter.py', '../_base_/datasets/loveda.py',
    '../_base_/default_runtime.py', '../_base_/schedules/adamw_40k.py'
]

work_dir = "work_dirs/segmentation/loveda/{{fileBasenameNoExtension}}"
...
default_hooks = dict(
    checkpoint = dict(max_keep_ckpts=1, save_best=['mIoU'],interval=4000),
)